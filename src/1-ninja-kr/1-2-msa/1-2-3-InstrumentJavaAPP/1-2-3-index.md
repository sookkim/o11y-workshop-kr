# 3. Instrument a Java application with OpenTelemetry
...
- `--set="operatorcrds.install=true","--set="operator.enabled=true"` 옵션을 통해 제로코드 계측에 필요한 라이브러리를 다운로드 받았습니다
...
- 화면 상단의 필터를 **Environment : _<실습자 이름>_\_handson** 으로 설정하여, 내가 설정한 APM 데이터만 추려서 확인합니다
  <img src="../../../images/1-ninja-kr/1-2-3-apm.jpg" width="1200" style="border: 1px solid #000; display: block; margin-left: 0;">

</br>

- **[APM] > [Service Map]** 화면으로 이동하여 각 마이크로 서비스가 어떻게 통신하고있는지 서비스맵을 확인합니다
  <img src="../../../images/1-ninja-kr/1-2-3-servicemap.jpg" width="1200" style="border: 1px solid #000; display: block; margin-left: 0;">
