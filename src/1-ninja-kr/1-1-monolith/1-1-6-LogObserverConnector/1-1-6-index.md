...
<img src="../../../images/1-ninja-kr/1-10-configurations1.png" width="1200" style="border: 1px solid #000; display: block; margin-left: 0;">
...
- 또한 indexes_list_all은 선택 해제 하세요
  <img src="../../../images/1-ninja-kr/1-10-configuration3.png" width="1000" style="border: 1px solid #000; display: block; margin-left: 0;">

- [Save] 를 눌러 롤 생성을 완료합니다

Splunk Cloud Platform에서 **[Settings] > [Users]** 에서 Log Observer Connect 서비스 계정의 사용자를 생성합니다. 역할 할당 섹션에서 이전 단계에서 Log Observer Connect 서비스 계정에 대해 생성한 역할을 사용자에게 할당합니다.

<img src="../../../images/1-ninja-kr/1-10-configuration4.png" width="1000" style="border: 1px solid #000; display: block; margin-left: 0;">
...
<img src="../../../images/1-ninja-kr/1-10-configuration7.jpg" width="1200" style="border: 1px solid #000; display: block; margin-left: 0;">
